...
public class StudentRun {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<4;i++) {
			...
			// parsing : 어떤 큰 자료에서 원하는 자료만 가공하고 뽑아서 원하는 때에 불러올 수 있게 하는 것
			// parse :  parsing 을 수행하는 프로그램 
			
		    //  parseInt : 문자열에서  Integer의 형식으로  구문을 분석(파싱)하는 메서드
			Integer studentID =Integer.parseInt(st.nextToken().trim()) ;
			//  parseDouble : 문자열에서  double의 형식으로  구문을 분석(파싱)하는 메서드
