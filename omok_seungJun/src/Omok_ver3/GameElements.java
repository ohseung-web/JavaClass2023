...
public class GameElements {
	...
	public void cpuPlaceStone() { // 컴퓨터가 돌을 놓을 때
		...
		else if(edgeFourRowCheck()) { // 흑돌이 '가장자리'에 같은 돌을 4개 늘어놓았을 때
			edgeFourRowPlaceStone();
		}
		...
		else if(edgeThreeRowCheck()) { // 흑돌이 '가장자리에' 같은 돌을 3개 늘어놓았을 때
			edgeThreeRowPlaceStone();
		}
		...
		else if(edgeTwoRowCheck()) { // 흑돌이 '가장자리'에 같은 돌을 2개 늘어놓았을 때
			edgeTwoRowPlaceStone();
		}
	...
	public boolean edgeFourRowCheck() { // 흑돌이 '가장자리에' 같은 돌을 4개 늘어놓았는지 확인
		for(int i=0;i<checkerboard.length;i++) { 
			for(int j=0;j<checkerboard[i].length;j++) {
				if(i==0 // (위쪽 모서리, ↓)
				&&(checkerboard[i][j].equals("●")
				...
				else if(i==0 && j<checkerboard[i].length-4 // (위쪽 모서리, ↘)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j+1].equals("●")
				&& checkerboard[i+2][j+2].equals("●")
				&& checkerboard[i+3][j+3].equals("●")
				...
				else if(i==checkerboard.length-1 // (아래쪽 모서리, ↑)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j].equals("●")
				&& checkerboard[i-2][j].equals("●")
				&& checkerboard[i-3][j].equals("●")
				...
				else if(i==checkerboard.length-1 && j<checkerboard[i].length-4 // (아래쪽 모서리, ↗)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j+1].equals("●")
				&& checkerboard[i-2][j+2].equals("●")
				&& checkerboard[i-3][j+3].equals("●")
				...
				else if(i==checkerboard.length-1 && j>3 // (아래쪽 모서리, ↙)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j-1].equals("●")
				&& checkerboard[i-2][j-2].equals("●")
				&& checkerboard[i-3][j-3].equals("●")
				...
				else if(i<checkerboard.length-4 && j==0 // (왼쪽 모서리, ↘)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j+1].equals("●")
				&& checkerboard[i+2][j+2].equals("●")
				&& checkerboard[i+3][j+3].equals("●")
				...
				else if(j==checkerboard[i].length-1 // (오른쪽 모서리, ←)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i][j-1].equals("●")
				&& checkerboard[i][j-2].equals("●")
				&& checkerboard[i][j-3].equals("●")
				...
				else if(i<checkerboard.length-4 && j==checkerboard[i].length-1 // (오른쪽 모서리, ↙)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j-1].equals("●")
				&& checkerboard[i+2][j-2].equals("●")
				&& checkerboard[i+3][j-3].equals("●")
				...
				else if(i>3 && j==checkerboard[i].length-1 // (오른쪽 모서리, ↖)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j-1].equals("●")
				&& checkerboard[i-2][j-2].equals("●")
				&& checkerboard[i-3][j-3].equals("●")
	...
	public void edgeFourRowPlaceStone() { // 흑돌이 가장자리에 같은 돌을 4개 늘어놓았을 때 백돌이 놓을 자리 정하기
		if(type==1) {
	...
	public boolean edgeThreeRowCheck() { // 흑돌이 '가장자리에' 같은 돌을 3개 늘어놓았는지 확인
		for(int i=0;i<checkerboard.length;i++) { 
			for(int j=0;j<checkerboard[i].length;j++) {
				if(i==0 // (위쪽 모서리, ↓)
				&&(checkerboard[i][j].equals("●")
				...
				else if(i==0 && j<checkerboard[i].length-3 // (위쪽 모서리, ↘)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j+1].equals("●")
				&& checkerboard[i+2][j+2].equals("●")
				&& checkerboard[i+3][j+3].equals("-"))) {
				...
				else if(i==checkerboard.length-1 && j<checkerboard[i].length-3 // (아래쪽 모서리, ↗)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j+1].equals("●")
				&& checkerboard[i-2][j+2].equals("●")
				&& checkerboard[i-3][j+3].equals("-"))) {
				...
				else if(i==checkerboard.length-1 && j>2 // (아래쪽 모서리, ↙)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j-1].equals("●")
				&& checkerboard[i-2][j-2].equals("●")
				&& checkerboard[i-3][j-3].equals("-"))) {
				...
				else if(i<checkerboard.length-3 && j==0 // (왼쪽 모서리, ↘)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j+1].equals("●")
				&& checkerboard[i+2][j+2].equals("●")
				&& checkerboard[i+3][j+3].equals("-"))) {
				...
				else if(i<checkerboard.length-3 && j==checkerboard[i].length-1 // (오른쪽 모서리, ↙)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j-1].equals("●")
				&& checkerboard[i+2][j-2].equals("●")
				&& checkerboard[i+3][j-3].equals("-"))) {
				...
				else if(i>2 && j==checkerboard[i].length-1 // (오른쪽 모서리, ↖)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j-1].equals("●")
				&& checkerboard[i-2][j-2].equals("●")
				&& checkerboard[i-3][j-3].equals("-"))) {
	...
	public void edgeThreeRowPlaceStone() { // 흑돌이 가장자리에 같은 돌을 3개 늘어놓았을 때 백돌이 놓을 자리 정하기
		if(type==1) {
	...
	public boolean edgeTwoRowCheck() { // 흑돌이 '가장자리에' 같은 돌을 2개 늘어놓았는지 확인
		for(int i=0;i<checkerboard.length;i++) { 
			for(int j=0;j<checkerboard[i].length;j++) {
				if(i==0 // (위쪽 모서리, ↓)
				&&(checkerboard[i][j].equals("●")
				...
				else if(i==0 && j<checkerboard[i].length-2 // (위쪽 모서리, ↘)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j+1].equals("●")
				&& checkerboard[i+2][j+2].equals("-"))) {
					check = i;
				...
				else if(i==checkerboard.length-1 && j<checkerboard[i].length-2 // (아래쪽 모서리, ↗)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j+1].equals("●")
				&& checkerboard[i-2][j+2].equals("-"))) {
					check = i;
				...
				else if(i==checkerboard.length-1 && j>1 // (아래쪽 모서리, ↙)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j-1].equals("●")
				&& checkerboard[i-2][j-2].equals("-"))) {
					check = i;
				...
				else if(i<checkerboard.length-2 && j==0 // (왼쪽 모서리, ↘)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j+1].equals("●")
				&& checkerboard[i+2][j+2].equals("-"))) {
					check = i;
				...
				else if(i<checkerboard.length-2 && j==checkerboard[i].length-1 // (오른쪽 모서리, ↙)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i+1][j-1].equals("●")
				&& checkerboard[i+2][j-2].equals("-"))) {
					check = i;
				...
				else if(i>1 && j==checkerboard[i].length-1 // (오른쪽 모서리, ↖)
				&&(checkerboard[i][j].equals("●")
				&& checkerboard[i-1][j-1].equals("●")
				&& checkerboard[i-2][j-2].equals("-"))) {
					check = i;
	...
	public void edgeTwoRowPlaceStone() { // 흑돌이 가장자리에 같은 돌을 2개 늘어놓았을 때 백돌이 놓을 자리 정하기
		if(type==1) {
			checkerboard[check+2][check2] = "○";
			printCheckerboard();
			cpuFiveRowCheck();
		}
		else if(type==2) {
			checkerboard[check+2][check2+2] = "○";
			printCheckerboard();
			cpuFiveRowCheck();
		}
		else if(type==3) {
